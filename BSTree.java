...
//=============================================================
    ...
    Node father(int xPrice) // return the father of the node q, where q.info.price = xPrice
    {
        Node f, p;
        f = null;
        p = root;
    ...
    void f4() throws Exception {
       ...
       to complete the question in the exam paper.*/
        breadth3(root, f);
        int xPrice = rotate.info.price;
        Node r = rotateRight(rotate);
        Node q = father(xPrice);
        if (q == null) {
            root = r;
        } else {
            if (q.left == rotate) {
